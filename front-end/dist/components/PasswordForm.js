    ...
    pwMailButton.addEventListener('click', function (event) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('Request Password Mail Error:', error_1);
                    return [3 /*break*/, 4];
    ...
    usernameBtn.addEventListener('click', function (event) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error('Update Password Error:', error_2);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    answerBtn.addEventListener('click', function (event) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    event.preventDefault();
                    answerValue = getInputValue('answer');
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 3:
                    error_3 = _a.sent();
                    console.error('Update Password Error:', error_3);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
